(() => {
  ...
  const metrics=document.querySelector('.pubMetrics');const chart=document.createElement('div');chart.className='publicationChart panel';const journalCount=S.journals.length,conferenceCount=S.conferences.length,total=journalCount+conferenceCount,portion=total?journalCount/total*100:0;
